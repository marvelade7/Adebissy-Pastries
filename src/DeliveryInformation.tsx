    ...
    return (
        <div data-aos='fade-up' data-aos-delay='120' className='flex flex-col w-full gap-15 px-4 py-7 md:py-10 sm:px-8 lg:px-20 md:flex-row md:gap-10'>
            ...
            <div className="lg:w-1/2 w-full">
                ...
                <p data-aos='fade-up' data-aos-delay='300' className="mb-7 md:text-2xl text-lg">Fresh Pastries delivered across Ogbomoso, Ilorin, and surrounding areas in Kwara</p>
