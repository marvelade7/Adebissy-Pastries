    ...
    return (
        <div data-aos='fade-up' data-aos-delay='100' className='px-4 md:py-15 py-10 sm:px-8 lg:px-20'>
            ...
            <div className='flex flex-col w-full items-stretch gap-5 md:flex-row lg:gap-10'>
                <div data-aos='fade-up' data-aos-delay='220' className='w-full border border-[#72462c83] rounded-2xl py-6 px-6  bg-[#FFFEF7]'>
                ...
                <div data-aos='fade-up' data-aos-delay='420' className='w-full border border-[#72462c83] rounded-2xl py-6 px-6  bg-[#FFFEF7]'>
                    <img src="./heroImg3.png" width="200" className='mx-auto mb-5' />
